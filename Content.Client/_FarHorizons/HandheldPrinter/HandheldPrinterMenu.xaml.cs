...
public sealed partial class HandheldPrinterMenu : DefaultWindow
{
    [Dependency] private readonly IEntityManager _entityManager = default!;
    [Dependency] private readonly IPrototypeManager _prototypeManager = default!;

    private readonly SpriteSystem _spriteSystem;
    private readonly HandheldPrinterSystem _lathe;
    ...
    public HandheldPrinterMenu()
    {
        RobustXamlLoader.Load(this);
        IoCManager.InjectDependencies(this);

        _spriteSystem = _entityManager.System<SpriteSystem>();
        _lathe = _entityManager.System<HandheldPrinterSystem>();
    ...
    public void SetEntity(EntityUid uid)
    {
        ...
        if (_entityManager.TryGetComponent<HandheldPrinterComponent>(Entity, out var handheldComponent))
        {
            if (!handheldComponent.DynamicPacks.Any())
            {
                ServerListButton.Visible = false;
            }

            AmountLineEdit.SetText(handheldComponent.DefaultProductionAmount.ToString());
        }
    ...
    public void PopulateRecipes()
    {
        ...
        _entityManager.TryGetComponent(Entity, out HandheldPrinterComponent? lathe);

        foreach (var prototype in sortedRecipesToShow)
        {
            var canProduce = _lathe.CanProduce(Entity, prototype, quantity, component: lathe);

            var control = new HandheldRecipeControl(_lathe, prototype, () => GenerateTooltipText(prototype), canProduce, GetRecipeDisplayControl(prototype));
    ...
    private string GenerateTooltipText(LatheRecipePrototype prototype)
    {
        ...
        var multiplier = _entityManager.GetComponent<HandheldPrinterComponent>(Entity).MaterialUseMultiplier;
        ...
        foreach (var (id, amount) in prototype.Materials)
        {
            ...
            var adjustedAmount = HandheldPrinterSharedSystem.AdjustMaterial(amount, prototype.ApplyMaterialDiscount, multiplier);
