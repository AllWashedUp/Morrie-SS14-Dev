...
public sealed class HandheldPrinterSystem : HandheldPrinterSharedSystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<HandheldPrinterComponent, AppearanceChangeEvent>(OnAppearanceChange);
    }

    private void OnAppearanceChange(EntityUid uid, HandheldPrinterComponent component, ref AppearanceChangeEvent args)
    {
        if (args.Sprite == null)
            return;
