...
/// This handles...
/// </summary>
public abstract class HandheldPrinterSharedSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<HandheldPrinterComponent, ExaminedEvent>(OnExamined);
    ...
    /// </summary>
    public HashSet<ProtoId<LatheRecipePrototype>> GetAllPossibleRecipes(HandheldPrinterComponent component)
    {
    ...
    private void OnExamined(Entity<HandheldPrinterComponent> ent, ref ExaminedEvent args)
    {
    ...
    [PublicAPI]
    public bool CanProduce(EntityUid uid, string recipe, int amount = 1, HandheldPrinterComponent? component = null)
    {
        return _proto.TryIndex<LatheRecipePrototype>(recipe, out var proto) && CanProduce(uid, proto, amount, component);
    }

    public bool CanProduce(EntityUid uid, LatheRecipePrototype recipe, int amount = 1, HandheldPrinterComponent? component = null)
    {
    ...
    protected abstract bool HasRecipe(EntityUid uid, LatheRecipePrototype recipe, HandheldPrinterComponent component);
